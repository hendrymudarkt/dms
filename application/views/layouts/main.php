		...
		<aside class="main-sidebar sidebar-light-primary elevation-4" style="background-color: #007BFF">
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item">
							<a href="#" class="nav-link" data-toggle="modal" data-target="#addModal">
								<i class="nav-icon fas fa-plus-square" style="color: #ADD5FF"></i>
								<p style="color: #ADD5FF">
									Tambah Dokumen
								</p>
							</a>
						...
						<li class="nav-item">
							<a href="<?php echo site_url('insiden');?>" class="nav-link">
								<i class="nav-icon fas fa-diagnoses" style="color: #ADD5FF"></i>
								<p style="color: #ADD5FF">
						...
						<li class="nav-item">
							<a href="<?php echo site_url('laporan/activity');?>" class="nav-link">
								<i class="nav-icon fas fa-list-alt" style="color: #ADD5FF"></i>
								<p style="color: #ADD5FF">
									Laporan
								</p>
							</a>
						...
						<li class="nav-item">
							<a href="<?php echo site_url('user') ?>" class="nav-link">
								<i class="fas fa-user nav-icon" style="color: #ADD5FF"></i>
								<p style="color: #ADD5FF">Pengguna</p>
							</a>
						</li>
						<li class="nav-item">
